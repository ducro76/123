...
{
    public class QuanLyVienController : Controller
    {
        // GET: QuanLyVien
        DataQLNCKHDataContext db = new DataQLNCKHDataContext();
        // GET: QuanLy
        public ActionResult PartialMenuQLV()
        {
            return PartialView();
        }
        ...
        public ActionResult DsDeCuong(string strLoc1, string strLoc2)
        {
            ...
            List<DTDangKy> listdecuong = DangKyDAO.Instance.ListDSDeCuongTheoVien(gv.MaKhoa);
            ...
            else
            {
                ...
                List<DTDangKy> listdecuongloc = DangKyDAO.Instance.ListDSDeCuongTheoVienLoc(gv.MaKhoa, DateTime.Parse(strLoc1), DateTime.Parse(strLoc2));
                return View(listdecuongloc); 
            }
        }
        [HttpGet]
        public void GenerateReportDeCuong(string str1, string str2)
        {
            GIANGVIEN gv = LayGiangVien();
            List<DTDangKy> listdecuong = DangKyDAO.Instance.ListDSDeCuongTheoVien(gv.MaKhoa);
            ...
            else
            {
                ...
                List<DTDangKy> listDangKyloc = DangKyDAO.Instance.ListDSDeCuongTheoVienLoc(gv.MaKhoa,DateTime.Parse(str1), DateTime.Parse(str2));
        ...
        public void GenerateReportDeTai(string str1, string str2)
        {
            ...
            GIANGVIEN GV = LayGiangVien();
            List<DTDeTai> listdetai = DeTaiDAO.Instance.ListTongDeTaiVien(GV.MaKhoa);
            ExcelPackage pck = new ExcelPackage();
            ExcelWorksheet ws = pck.Workbook.Worksheets.Add("Report");
            ws.Cells["A1"].Value = "Communication";
            ws.Cells["B1"].Value = "Com1";
            ...
            else
            {
                ...
                List<DTDeTai> listDeTaiLoc = DeTaiDAO.Instance.ListTongDeTaiVienLoc(GV.MaKhoa,DateTime.Parse(str1), DateTime.Parse(str2));
        ...
        public ActionResult DsDeTai(string strLoc1, string strLoc2)
        {
            ...
            {
                List<DTDeTai> listDangKyloc = DeTaiDAO.Instance.ListTongDeTaiVienLoc(gv.MaKhoa,DateTime.Parse(strLoc1), DateTime.Parse(strLoc2));
